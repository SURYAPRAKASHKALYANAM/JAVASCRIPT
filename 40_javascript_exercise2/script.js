...
//generate index
let jokeindex=Math.floor(Math.random()*myjokes.length);
console.log(myjokes[jokeindex].joke);


let jokebox=document.getElementById("jokeBox");
console.log(jokebox);
let p=jokebox.querySelector("p");
p.innerHTML=myjokes[jokeindex].joke;


let btn=document.getElementsByClassName("button-primary-outlined")[0];
